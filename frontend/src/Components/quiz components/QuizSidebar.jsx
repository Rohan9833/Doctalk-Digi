  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-5 space-y-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500 mt-1">
            Version {quiz.version} • {quiz.questions} Questions
          </p>
        </div>

        <span className="text-[11px] bg-green-100 text-green-600 px-2 py-1 rounded-md font-medium">
          Active
        </span>
      </div>
      ...
      <div className="space-y-3 text-sm">
        <div>
          <p className="text-xs text-gray-500">Linked Campaign</p>
          <p className="text-sm text-indigo-600 font-medium cursor-pointer">
            GERD Awareness Campaign
          </p>
        </div>

        <div>
          <p className="text-xs text-gray-500">Therapy Area</p>
          <p className="text-sm text-gray-800">{quiz.therapyArea}</p>
        </div>

        <div>
          <p className="text-xs text-gray-500">Client</p>
          <p className="text-sm text-gray-800">{quiz.client}</p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-600">Needs Improvement (0-39%)</span>
          </div>
        </div>
      </div>
